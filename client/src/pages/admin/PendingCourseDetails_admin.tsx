...
const PendingCourseDetails_admin = () => {
    ...
    <>
      ...
      {showApproveConfirm && (
        <ConfirmationPopup_Admin
          isActionPositive={true}
          confirmText={`Approve this course : ${course?.title}?`}
          onCancel={() => setShowApproveConfirm(false)}
          onConfirm={approveCourse}
        />
      )}
      {showRejectConfirm && (
        <ConfirmationPopup_Admin
          confirmText={`Reject this course : ${course?.title}?`}
          onCancel={() => setShowRejectConfirm(false)}
          onConfirm={rejectCourse}
        />
      )}
...
export default PendingCourseDetails_admin;
